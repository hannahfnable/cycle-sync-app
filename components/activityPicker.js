        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4">
              {currentPhase && (
                <div className={`mb-4 p-3 rounded-2xl ${phaseConfig[currentPhase]?.bg}`}>
                  <p className={`text-sm ${phaseConfig[currentPhase]?.text}`}>
                    {phaseConfig[currentPhase]?.emoji} Activities marked with a dot are recommended for your current {currentPhase} phase
                  </p>
                </div>
              )}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {isRecommended && (
                            <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${phaseConfig[currentPhase]?.color}`} />
                          )}
                        </div>
