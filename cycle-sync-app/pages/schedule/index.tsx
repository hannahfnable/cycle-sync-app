...
import { calculateCycleInfo, getPhaseForDate } from '@/utils/cycleUtils';
        ...
        >
          ...
          {userActivities.length === 0 && (
            <p className="text-sm text-slate-500 text-center mt-2">
              Add activities in <Link href='Discover' className="text-violet-600 font-medium">Discover</Link> first
            </p>
          )}
        </motion.div>
